...
function SignUp() {
  ...
  return (
    <>
      {!showhidePop ? (
        <>
          <div className=" bg-white md:rounded-[20px] md:border-[2px] border-[#D4D4D4]  px-[34px] md:px-[70px] py-10 w-full md:w-[500px] gap-5 min-h-screen md:min-h-full md:h-[641px] flex flex-col justify-evenly relative md:justify-between items-center">
            <button
