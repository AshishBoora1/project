...
function SignIn() {
  ...
  return (
    <>
      {!showhidePop ? (
        <>
          <div className=" bg-white md:rounded-[20px] md:border-[2px] border-[#D4D4D4]  px-[34px] md:px-[70px] pb-[35px] pt-10 w-full md:w-[500px] gap-5 min-h-screen md:min-h-full md:h-[621px] relative flex flex-col justify-evenly md:justify-between items-center">
            <button
